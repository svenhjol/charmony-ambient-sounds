...
public class Jungle implements SoundType<BiomeSound> {
    ...
    public Jungle() {
        daySound = SoundEvent.createVariableRangeEvent(Charmony.id("biome.jungle.day"));
        nightSound = SoundEvent.createVariableRangeEvent(Charmony.id("biome.jungle.night"));
    }

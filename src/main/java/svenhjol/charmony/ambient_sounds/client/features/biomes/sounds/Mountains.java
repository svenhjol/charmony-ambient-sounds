...
public class Mountains implements SoundType<BiomeSound> {
    ...
    public Mountains() {
        daySound = SoundEvent.createVariableRangeEvent(Charmony.id("biome.mountains.day"));
        nightSound = SoundEvent.createVariableRangeEvent(Charmony.id("biome.mountains.night"));
    }

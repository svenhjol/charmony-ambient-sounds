...
public class Badlands implements SoundType<BiomeSound> {
    ...
    public Badlands() {
        daySound = SoundEvent.createVariableRangeEvent(Charmony.id("biome.badlands.day"));
        nightSound = SoundEvent.createVariableRangeEvent(Charmony.id("biome.badlands.night"));
    }

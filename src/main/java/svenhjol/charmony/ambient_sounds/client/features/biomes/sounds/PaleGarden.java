...
public class PaleGarden implements SoundType<BiomeSound> {
    ...
    public PaleGarden() {
        daySound = SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(AmbientSoundsMod.ID, "biome.pale_garden.day"));
        nightSound = SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(AmbientSoundsMod.ID, "biome.pale_garden.night"));
    }

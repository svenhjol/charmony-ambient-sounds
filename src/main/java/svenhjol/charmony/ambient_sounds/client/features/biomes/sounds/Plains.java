...
public class Plains implements SoundType<BiomeSound> {
    ...
    public Plains() {
        daySound = SoundEvent.createVariableRangeEvent(Charmony.id("biome.plains.day"));
        nightSound = SoundEvent.createVariableRangeEvent(Charmony.id("biome.plains.night"));
    }
